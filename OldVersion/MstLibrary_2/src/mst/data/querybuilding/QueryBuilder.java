...
import static mst.data.connection.ConnectionTypes.*;
...
public class QueryBuilder implements IQueryBuilder, IQueryTypes {
    ...
    private ConnectionTypes _connectionType = null;
    ...
    public QueryBuilder(IBaseBO baseBO, QueryTypes queryType) throws Throwable {
        this(baseBO, queryType, ConnectionTypes.ApacheDerby);
    }

    public QueryBuilder(IBaseBO baseBO, QueryTypes queryType, ConnectionTypes connectionType) throws Throwable {
